...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <link rel="stylesheet" type="text/css" href="../style.css?rnd=1.3">
  ...
  <form method="post" action="loginf.php">
    <?php include('errors.php'); ?>
      ...
      <div class="input-group form-group">
		...
		<div class="form-item">
		<p class="pull-left"><a href="../account/register.php"><small>Register</small></a></p>
    <div class="input-group">
      <button type="submit" class="login pull-right btn btn-login float-right" value="Log In" name="loginf_user">Login</button>
    </div>
